...
/** @internal **/
export const context: IModuleContext = new ModuleContext("com-sabre-redappexample-web-module");
/** @internal **/
...
/** @internal **/
export const t: ScopedTranslator = getService(I18nService).getScopedTranslator('com-sabre-redappexample-web-module/translations');
